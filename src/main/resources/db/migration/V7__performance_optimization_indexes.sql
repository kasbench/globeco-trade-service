...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trade_orders_portfolio_security_covering 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trade_orders_active_portfolio_security 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_trade_order_covering 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_service_id_timestamp 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_status_timestamp_desc 
ON execution (execution_status_id, execution_timestamp DESC);

-- Index for quantity range queries on executions
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_quantities_range 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_blotter_trade_type_timestamp 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trade_orders_portfolio_security_submitted_timestamp 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_trade_order_status_timestamp 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trade_orders_blotter_submitted_timestamp 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_destination_status_timestamp 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_trade_type_status_timestamp 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_unfilled 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_partially_filled 
ON execution (execution_status_id, execution_timestamp DESC, trade_order_id) 
WHERE quantity_filled > 0 AND quantity_filled < quantity_ordered;

-- Index for fully filled executions
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_fully_filled 
ON execution (execution_status_id, execution_timestamp DESC, trade_order_id) 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trade_orders_id_desc_portfolio 
ON trade_order (id DESC, portfolio_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_id_desc_status 
ON execution (id DESC, execution_status_id);

-- Timestamp-based pagination indexes
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trade_orders_timestamp_desc_portfolio_security 
ON trade_order (trade_timestamp DESC, portfolio_id, security_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_executions_timestamp_desc_trade_order 
