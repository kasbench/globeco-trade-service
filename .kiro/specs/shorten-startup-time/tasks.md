...
- [ ] 1. Upgrade Java toolchain and configure bootBuildImage in build.gradle
  - [ ] 1.1 Upgrade Java toolchain from 21 to 25 and add bootBuildImage configuration
...
- [ ] 2. Update Dockerfile base images to Java 25
  - [ ] 2.1 Update Dockerfile FROM statements to Java 25
...
- [ ] 3. Rewrite kbuild.sh for multi-arch bootBuildImage builds
  - [ ] 3.1 Rewrite kbuild.sh to use sequential bootBuildImage invocations and docker manifest
...
- [ ] 4. Checkpoint - Verify local build
...
- [ ] 5. Update CI workflow for Java 25 and bootBuildImage
  - [ ] 5.1 Update .github/workflows/docker-publish.yml to Java 25 and bootBuildImage-based builds
